  ...
  return (
    <View style={styles.container}>
      ...
      <View className='gap-5'>
        <TouchableOpacity className='flex-row justify-between items-center' onPress={() => navigation.navigate('Login')}>
        ...
        <TouchableOpacity className='flex-row justify-between items-center' onPress={() => navigation.navigate('Register')}>
