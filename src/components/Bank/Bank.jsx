...
const Bank = ({ bank }) => {
    ...
    return (
        <TouchableOpacity className='flex-row w-11/12 bg-white rounded-xl mt-2'>
            <Image source={{
                uri: 'https://th.bing.com/th/id/OIP.xyxDIDb8CbfvGOG8NsmDrQHaHU?rs=1&pid=ImgDetMain'
            }} style={{ height: 40, width: 40, borderRadius: 10 }} className='w-2/12' />
            <View className='w-9/12  gap-1 ml-1'>
                <Text className='text-base font-semibold text-gray-700'>Agribank - 0298818xxxx</Text>
